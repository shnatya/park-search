...
ActiveRecord::Schema[7.0].define(version: 2022_08_30_182504) do
  ...
  create_table "facility_copies", force: :cascade do |t|
    t.string "name"
    t.string "description"
    t.string "facility_code"
    t.datetime "created_at", null: false
  ...
  create_table "trips", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["facility_id"], name: "index_trips_on_facility_id"
